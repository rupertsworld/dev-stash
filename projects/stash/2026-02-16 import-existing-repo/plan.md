...
### 4. No changes to SyncProvider interface

`listFiles()` and `fetchFile()` are GitHubProvider-specific methods, only used by the create command. They don't belong in the generic SyncProvider interface.
